            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="col-md-10 col-md-offset-1" id="add_new_diagram_form">
                        <h3 class="text-center">Add Survey</h3>
                        <br>
                        <form autocomplete="off" enctype="multipart/form-data" class="form-horizontal" action="{{route('post_add_survey')}}" method="post" id="add_diagram_form">
                            {!! csrf_field() !!}
                            ...
                            <div class="modal-footer">
                                <button id="create_diagram_button" type="submit" class="btn btn-info" >Add Survey</button>
                            </div>
                        </form>
                    </div>
                </div>
