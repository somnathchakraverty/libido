            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="col-md-10 col-md-offset-1" id="add_new_diagram_form">
                        ...
                        <br>
                        <form autocomplete="off" enctype="multipart/form-data" class="form-horizontal" action="{{route('post_edit_question')}}" method="post" id="add_diagram_form">
                            {!! csrf_field() !!}
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input required type="text" name = "name" class="form-control" id="name" placeholder="Enter Question" value="{{$question}}">
                                </div>
                                <input type="hidden" name="question_id" id="question_id" value="{{$id}}">
                            </div>
                            <br>
                            <div class="modal-footer">
                                <button id="create_diagram_button" type="submit" class="btn btn-info" >Update Question</button>
                            </div>
                        </form>
                    </div>
                </div>
