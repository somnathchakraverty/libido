...
class AddEncounterStepFourRequest extends LaravelFormRequest {
    /**
    ...
    public function rules() {
        ...
        return [
            'isToyUsed' => 'required|integer',
            'isIntoxicantUsed' => 'required|integer',
            'isLubricationUsed' => 'required|integer',
            'isIntercourse' => 'required|integer',
            'encounterId' => 'required|integer',
            'toys' => 'array',
            'isEdited' => 'required|integer',
        ];
    }
